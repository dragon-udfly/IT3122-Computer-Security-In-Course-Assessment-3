...
<html>
<head>
    <title>Secure Stored XSS Solution</title>
    <style>
...
<body>
    <h1>Stored XSS Secure Solution (Comment Section)</h1>
    
    <form method="POST">
        <h3>Leave a Comment (Secure)</h3>
    ...
    <div class="comment-display">
        ...
        while ($row = $stmt->fetch()) {
            echo "<div class='comment-item'>" . htmlentities($row['comment_text'], ENT_QUOTES, 'UTF-8') . "</div>";
        }
        ?>
    </div>
</body>
