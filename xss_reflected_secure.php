...
<html>
<head>
    <title>Reflected XSS Secure Solution</title>
    <style>
        ...
        th { background-color: #8ce98c; }
    </style>
</head>
<body>
    <h1>Reflected XSS Secure Solution</h1>
    ...
    if (!empty($item_name) || count($results) > 0) {
        ...
        echo "<h2>Search Results for: " . htmlentities($item_name, ENT_QUOTES, 'UTF-8') . "</h2>";
